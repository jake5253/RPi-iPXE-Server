...
_unhandle_iso  $OPENSUSE_X64  $OPENSUSE_X64_URL  timestamping  ,gid=root,uid=root,norock,mode=292  vbladed 1 1;
...
####### My Additions ######
#OS
handle_iso $mint_cin $mint_cin_url is_local;
handle_iso $arch $arch_url is_local;
handle_iso $mint_xfce $mint_xfce_url is_local;
handle_iso $deepin $deepin_url is_local;
handle_iso $element $element_url is_local;

#Repair
handle_iso $boot_repair $boot_repair_url is_local;
handle_iso $acronis_aio $acronis_aio_url is_local;
handle_iso $gparted $gparted_url is_local;
handle_iso $ifl $ifl_url is_local;
handle_iso $ifd $ifd_url is_local;
handle_iso $ifu $ifu_url is_local;

#More different repair/windows
handle_iso $dos $dos_url is_local;
handle_iso $hbcd $hbcd_url is_local;
handle_iso $bobombs $bobombs_url is_local;
handle_iso $win10 $win10_url is_local;

#bootloaders
handle_iso $plop $plop_url is_local;
handle_iso $clover $clover_url is_local;
