...
####### My Additions #######
mint_cin=mint-cinnamon-x64
mint_cin_url=/media/pi/linuxmint-20-cinnamon-64bit.iso

mint_xfce=mint-xfce-x64
mint_xfce_url=/media/pi/linuxmint-20-xfce-64bit.iso

arch=archlinux-x64
arch_url=/media/pi/archlinux-2020.09.01-x86_64.iso

deepin=deepin-1002-x64
deepin_url=/media/pi/deepin-1002-x64.iso

element=elementary-os-5.1-x64
element_url=/media/pi/elementaryos-5.1.iso

boot_repair=boot-repair-disk-x64
boot_repair_url=/media/pi/boot-repair-disk-64bit.iso

acronis_aio=acronis-aio-x64
acronis_aio_url=/media/pi/Acronis_All-in-One.iso

gparted=gparted-live-1.1.0-5-x86
gparted_url=/media/pi/gparted-live-1.1.0-5-i686.iso

ifl=image-for-linux-x86
ifl_url=/media/pi/IF_Linux.ISO

ifd=image-for-dos-x86
ifd_url=/media/pi/IF_DOS.ISO

ifu=image-for-uefi-x64
ifu_url=/media/pi/IF_UEFI.ISO

hbcd=hirens-boot-cd-x64
hbcd_url=/media/pi/HBCD_PE_x64.iso

bobombs=bobombs-v4.8-x86
bobombs_url=/media/pi/BobOmbs.v4.8.ISO

dos=dos-6.22-x86
dos_url=/media/pi/DOS6.22.iso

win10=windows-10-19041.208.200416-2050-x64
win10_url=/media/pi/Win10-19041.208.200416-2050.ISO

clover=clover-2.5k-5070-x64
clover_url=/media/pi/CloverPLUS-v2.5k-5070-X64.iso

plop=plop-boot-x86
plop_url=/media/pi/plpbt.iso
